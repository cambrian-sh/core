...
//     arm is on (populated at the Step→DispatchTask boundary), so the control arm
...
func PassesDeclaration(manifest *domain.AgentManifest, task *domain.DispatchTask, canonical bool) bool {
