...
func (g *capturingGateway) GenerateWithTools(_ context.Context, _ domain.LeaseID, _ []domain.ModelMessage, _ domain.GenerateOptions, _ []domain.ToolDefinition) (domain.ModelTurn, error) {
