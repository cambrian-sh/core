...
var legacyExecutionKey = map[string]string{
	...
	"auction_bid_timeout_ms":                   "routing",
	...
	"efe_exploration_bonus":                    "routing",
	"efe_traffic_percent":                      "routing",
	...
	"scout_discovery_roots":                    "scout",
	"scout_enabled":                            "scout",
	"scout_http_allow_private":                 "scout",
	"scout_http_probe_enabled":                 "scout",
	"scout_llm_tier_enabled":                   "scout",
	"scout_model":                              "scout",
	"scout_scan_cap":                           "scout",
